...
- Maintain a working picture of everything in flight across the apps: open issues, open/draft PRs, their CI status, which branches are stale or abandoned, and which HANDOFF.md/README "open items" exist per app.
